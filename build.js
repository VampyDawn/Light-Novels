...
const createNewNovel = (name, volumes, extras) => {
    ...
    let novelVolumeCount = document.createTextNode(volumes);
    let newNovelVolumeCount = document.createElement("h2");
    newNovelVolumeCount.classList.add("novelVolumeCount");
    newNovelVolumeCount.appendChild(novelVolumeCount);

    newNovel.appendChild(newNovelName);

    //This is for checking count when downloading new stuffs
    newNovel.appendChild(newNovelVolumeCount);
